...
description: This document reports on a systematic search which explores the landscape of cardiac magnetic resonance (CMR)-related publications in the last 5 years (2019-2024).
format: 
  dashboard:
    page-layout: full
    toc: true
