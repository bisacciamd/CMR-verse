...
# alt query includign "diagnostic imaging" > query <- "(Diagnostic Imaging[Mesh] AND Heart[Mesh]) OR Magnetic Resonance Imaging, Cine[Mesh] OR (Magnetic Resonance Angiography[Mesh] AND Heart [Mesh]) AND 2019[PDAT] : 2024[PDAT]"
